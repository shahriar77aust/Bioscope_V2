...
<html>
	<head>
			...
			<meta charset="UTF-8">
			<meta name="description" content="Anime Movies">
			<meta name="keywords" content="Movies,Ratings,Recent Release,Trailers">
			<meta name="viewport" content="width=device-width, initial-scale=1.0">
			<link rel="stylesheet" type="text/css" href="forAnimeMovies.css">
	</head>
	<body>
			<div id="pageWrap">
				<div id="logo">
					...
					<div id="mainContent">
						<div id="movieList">
							<table>
  								...
  								<tr>
    								<td><a href="previewAnimeMovies.php?a=Wolf Children(2012)">Wolf Children</a></td>
    							</tr>
    							<tr>
    								<td><a href="previewAnimeMovies.php?a=Hotarubi No Mori(2011)">Hotarubi No Mori</a></td>
    							</tr>
    							<tr>
    								<td><a href="previewAnimeMovies.php?a=Princess Mononka(1997)">Princess Mononka</a></td>
    							</tr>
    							<tr>
    								<td><a href="previewAnimeMovies.php?a=Howls Moving Castle(2004)">Howls Moving Castle</a></td>
    							</tr>
							</table>
						</div><!--movieList-->
					</div><!--mainContent-->
