<?php
	...
	$sql = "SELECT * FROM series WHERE name = '$series' ";
	...
	if (isset($_SESSION['vallue'])) {
		...
		$hits = $hits+1;
		$sql = "UPDATE  series SET userRating = $userRating, userHits = $hits WHERE  name = '$series' ";
			...
			<div id="header">
				...
				<div id="nav">
					<ul>
						...
						<li class="dropdown"><a href="toprated.php" class="dropBtn">Top Rated</a></li>
